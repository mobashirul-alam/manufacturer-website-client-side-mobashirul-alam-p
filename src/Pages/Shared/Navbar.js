        ...
        <div class="navbar bg-base-100 lg:px-12 sticky top-0 z-50">
            <div class="navbar-start">
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 font-medium">
                        {menu}
                    </ul>
                </div>
            ...
            <div class="navbar-end hidden lg:flex font-medium">
